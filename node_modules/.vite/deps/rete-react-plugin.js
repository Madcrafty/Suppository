import {
  ...
  loopConnectionPath
} from "./chunk-BTK5BE5I.js";
import {
  _slicedToArray
} from "./chunk-JGHAUOJU.js";
import {
  _get
} from "./chunk-ANPYPNB5.js";
import {
  BaseAreaPlugin
} from "./chunk-YKSK4DBD.js";
import "./chunk-Y3QGWSBW.js";
import {
  ct,
  pt
} from "./chunk-6K5UNO4I.js";
import {
  require_react_dom
    ...
    apply: function apply(f) {
      if (ready.current) {
        queueMicrotask(function() {
          return (0, import_react_dom.flushSync)(f);
        });
      } else {
        f();
      }
...
function ConnectionWrapper(props) {
  ...
  (0, import_react.useEffect)(function() {
    if (start && end)
      props.path(start, end).then(function(p) {
        return flush.apply(function() {
          return setPath(p);
        });
      });
...
function Minimap(props) {
  ...
  var ref = (0, import_react.useCallback)(function(node) {
...
var ReactPlugin = function(_Scope) {
  ...
  var _super = _createSuper(ReactPlugin2);
