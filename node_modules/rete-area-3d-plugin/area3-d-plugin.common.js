...
var ObjectHTML = /*#__PURE__*/function (_Object3D) {
  _inherits__default["default"](ObjectHTML, _Object3D);
  var _super = _createSuper$3(ObjectHTML);
  function ObjectHTML(element) {
    var _this;
    _classCallCheck__default["default"](this, ObjectHTML);
  ...
  _createClass__default["default"](ObjectHTML, [{
    key: "updateGeometry",
    value: function updateGeometry(geometry) {
      ...
      if (this.front) this.front.geometry = scaled || new three.BufferGeometry();
      if (this.back) this.back.geometry = scaled || new three.BufferGeometry();
    }
  }, {
    key: "updateMaterials",
...
var Content = /*#__PURE__*/function () {
  function Content(scene, scope, reordered) {
    ...
    _defineProperty__default["default"](this, "objects", new WeakMap());
    this.scene = scene;
    this.scope = scope;
...
var DragControls = /*#__PURE__*/function (_EventDispatcher) {
  _inherits__default["default"](DragControls, _EventDispatcher);
  var _super = _createSuper$2(DragControls);
  function DragControls(camera, domElement, getPlane) {
    var _this;
    _classCallCheck__default["default"](this, DragControls);
    _this = _super.call(this);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "enabled", true);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "intersections", []);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "selected", null);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "hovered", null);
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "objects", new Set());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "pointer", new three.Vector2());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "offset", new three.Vector3());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "intersection", new three.Vector3());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "worldPosition", new three.Vector3());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "inverseMatrix", new three.Matrix4());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "onPointerMove", function (event) {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "onPointerDown", function (event) {
      if (_this.enabled === false) return;
      _this.updatePointer(event);
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "onPointerCancel", function () {
      if (_this.enabled === false) return;
      if (_this.selected) {
        var eventData = {
          type: 'dragend',
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "updatePointer", function (event) {
  ...
  _createClass__default["default"](DragControls, [{
    key: "attach",
...
var DraggableObject3D = /*#__PURE__*/function (_ObjectHTML) {
  _inherits__default["default"](DraggableObject3D, _ObjectHTML);
  var _super = _createSuper$1(DraggableObject3D);
  function DraggableObject3D(element, events) {
    var _this;
    _classCallCheck__default["default"](this, DraggableObject3D);
    _this = _super.call(this, element);
    _this.events = events;
    return _this;
  }
  return _createClass__default["default"](DraggableObject3D);
}(ObjectHTML);
...
var HybridRenderer = /*#__PURE__*/function () {
  ...
  function HybridRenderer() {
    _classCallCheck__default["default"](this, HybridRenderer);
  ...
  _createClass__default["default"](HybridRenderer, [{
    key: "getContent",
...
function orbitControlsRestrictor(orbit, camera, check, updated) {
  ...
  orbit.addEventListener('change', /*#__PURE__*/_asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
...
var HybridScene = /*#__PURE__*/function () {
  function HybridScene(container) {
    _classCallCheck__default["default"](this, HybridScene);
    _defineProperty__default["default"](this, "root", new three.Scene());
    _defineProperty__default["default"](this, "canvases", new Map());
  ...
  _createClass__default["default"](HybridScene, [{
    ...
    value: function getPointerFrom(event, scope) {
      ...
      var raycaster = new three.Raycaster();
      var pointer = new three.Vector2((event.clientX - rect.left) / rect.width * 2 - 1, -(event.clientY - rect.top) / rect.height * 2 + 1);
...
function createClassicConnectionGeometry(path, width) {
  ...
  var geometry = new three.PlaneGeometry(100, 10, points.length - 1, 1);
  for (var i = 0; i < points.length; i++) {
    var normal = new three.Vector2(0, width / 2);
    var point = new three.Vector2(points[i].x, points[i].y);
    if (i > 0 && i < points.length - 1) {
      var prevPoint = new three.Vector2(points[i - 1].x, points[i - 1].y);
      var nextPoint = new three.Vector2(points[i + 1].x, points[i + 1].y);
      var vectorBetweenPoints = nextPoint.clone().sub(prevPoint);
      var normalBetweenPoints = new three.Vector2(-vectorBetweenPoints.y, vectorBetweenPoints.x).clone().normalize();
...
function connection(scope, props) {
  ...
  renderScope.addPipe(function (context) {
    ...
    if (context.type === 'connectionpath') {
      ...
      if (view) {
        var _path = context.data.path || reteRenderUtils.classicConnectionPath(context.data.points, 0.3);
...
function createClassicNodeGeometry(size, params) {
  ...
  var geometry = new three.ShapeGeometry(shape);
  var circle = new three.CircleGeometry(socketRadius, 16);
  var extra = [];
  if ('inputs' in size) {
...
function reroute(scope) {
  ...
  area.addPipe(function (context) {
    ...
    if (context.type === 'render' && context.data.type === 'reroute-pins') {
      var pinGeometry = new three.CircleGeometry(10, 16);
...
function lookAt(area, nodes, params) {
  ...
  var target = new three.Vector3(bbox.center.x, bbox.center.y, 0);
  var source = target.clone().add(new three.Vector3(0, 0, distance));
...
var Area3DPlugin = /*#__PURE__*/function (_BaseAreaPlugin) {
  _inherits__default["default"](Area3DPlugin, _BaseAreaPlugin);
  var _super = _createSuper(Area3DPlugin);
  function Area3DPlugin(argument) {
    var _this;
    _classCallCheck__default["default"](this, Area3DPlugin);
    ...
    _this.area = new Area(_this.container, argument instanceof Area3DPlugin ? argument.area.scene : null, _assertThisInitialized__default["default"](_this), {
    ...
    _this.area.scene.addCanvasFor(_assertThisInitialized__default["default"](_this));
    return _this;
  }
   ...
   */
  _createClass__default["default"](Area3DPlugin, [{
    key: "share",
    ...
    value: function setParent(scope) {
      var _this2 = this;
      _get__default["default"](_getPrototypeOf__default["default"](Area3DPlugin.prototype), "setParent", this).call(this, scope);
    ...
    key: "translate",
    value: function () {
      var _translate = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(id, _ref3) {
        var x, y, view;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(type, id) {
        var data;
  ...
  return Area3DPlugin;
}(reteAreaPlugin.BaseAreaPlugin);

exports.Area3DExtensions = index;
exports.Area3DPlugin = Area3DPlugin;
//# sourceMappingURL=area3-d-plugin.common.js.map
