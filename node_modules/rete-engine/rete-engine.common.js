...
var ControlFlow = /*#__PURE__*/function () {
   ...
   */
  _createClass__default["default"](ControlFlow, [{
    key: "add",
...
var ControlFlowEngine = /*#__PURE__*/function (_Scope) {
  ...
  _createClass__default["default"](ControlFlowEngine, [{
    key: "setParent",
    value: function setParent(scope) {
      _get__default["default"](_getPrototypeOf__default["default"](ControlFlowEngine.prototype), "setParent", this).call(this, scope);
...
var Dataflow = /*#__PURE__*/function () {
   ...
   */
  _createClass__default["default"](Dataflow, [{
    key: "add",
    value: function add(node, setup) {
      var affected = this.setups.get(node.id);
      if (affected) {
            ...
            case 8:
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  inputs[c.targetInput] = [].concat(_toConsumableArray__default["default"](previous), [sourceData[c.sourceOutput]]);
                }
              } catch (err) {
                _iterator.e(err);
              } finally {
...
var DataflowEngine = /*#__PURE__*/function (_Scope) {
  ...
  function DataflowEngine(configure) {
    ...
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "cache", new Cache(function (data) {
  ...
  _createClass__default["default"](DataflowEngine, [{
    key: "setParent",
    value: function setParent(scope) {
      _get__default["default"](_getPrototypeOf__default["default"](DataflowEngine.prototype), "setParent", this).call(this, scope);
      this.editor = this.parentScope(rete.NodeEditor);
