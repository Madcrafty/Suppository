/*!
* rete-auto-arrange-plugin v2.0.0
...
var StandardApplier = /*#__PURE__*/function (_Applier) {
  ...
  var _super = _createSuper$2(StandardApplier);
  function StandardApplier() {
    _classCallCheck(this, StandardApplier);
    return _super.apply(this, arguments);
  }
  _createClass(StandardApplier, [{
    key: "getValidShapes",
...
var TransitionApplier = /*#__PURE__*/function (_StandardApplier) {
  ...
  var _super = _createSuper$1(TransitionApplier);
  /**
  ...
  _createClass(TransitionApplier, [{
    key: "applyTiming",
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return this.animation.add(this.duration, "".concat(id, "_resize"), function (t) {
                ...
                return _get(_getPrototypeOf(TransitionApplier.prototype), "resizeNode", _this2).call(_this2, id, currentWidth, currentHeight);
              });
            case 6:
              return _context.abrupt("return", _context.sent);
            case 7:
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return this.animation.add(this.duration, "".concat(id, "_translate"), function (t) {
                ...
                return _get(_getPrototypeOf(TransitionApplier.prototype), "translateNode", _this3).call(_this3, id, currentX, currentY);
              });
            case 6:
...
var AutoArrangePlugin = /*#__PURE__*/function (_Scope) {
  ...
  var _super = _createSuper(AutoArrangePlugin);
  function AutoArrangePlugin() {
    var _this;
    _classCallCheck(this, AutoArrangePlugin);
    _this = _super.call(this, 'auto-arrange');
    _defineProperty(_assertThisInitialized(_this), "elk", new ELK());
    _defineProperty(_assertThisInitialized(_this), "demonstration", 'https://rtsys.informatik.uni-kiel.de/elklive/json.html');
   ...
   */
  _createClass(AutoArrangePlugin, [{
    key: "addPreset",
    ...
    value: function nodeToLayoutChild(node, context) {
      ...
      return _objectSpread(_objectSpread({
        ...
        ports: [].concat(_toConsumableArray(inputs.sort(function (a, b) {
          var _a$input, _b$input;
          return (((_a$input = a.input) === null || _a$input === void 0 ? void 0 : _a$input.index) || 0) - (((_b$input = b.input) === null || _b$input === void 0 ? void 0 : _b$input.index) || 0);
          ...
          var _a$output, _b$output;
          return (((_a$output = a.output) === null || _a$output === void 0 ? void 0 : _a$output.index) || 0) - (((_b$output = b.output) === null || _b$output === void 0 ? void 0 : _b$output.index) || 0);
    ...
    value: function () {
      var _layout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(props) {
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              nodes = (props === null || props === void 0 ? void 0 : props.nodes) || this.getEditor().getNodes();
              connections = (props === null || props === void 0 ? void 0 : props.connections) || this.getEditor().getConnections();
              graph = _objectSpread({
                id: 'root',
              ...
              applier = (props === null || props === void 0 ? void 0 : props.applier) || new StandardApplier();
